...
update_user_response = httpx.patch(f'http://localhost:8000/api/v1/users/{create_user_response_data['user']['id']}', json=update_user_data, headers=update_user_headers)
